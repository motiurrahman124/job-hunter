...
const FeaturedJobsCard = ({jobs}) => {
    
    return (
        <div className='border rounded-lg p-10'>
            <img className='h-[40px] w-auto mb-8' src={jobs.image} alt="" />
            ...
            <div className='text-[#757575] font-semibold text-xl mt-4 md:flex gap-x-7 items-center'>
